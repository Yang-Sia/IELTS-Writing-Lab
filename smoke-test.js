...
assertIncludes(html, 'id="autoVoiceBtn"', "automatic natural voice button");
...
assertIncludes(js, "google uk english female", "preferred natural female voice");
assertIncludes(js, "voiceProfileVersion", "improved voice recommendation migration");
...
assertIncludes(js, "renderInteractiveSpeakingTerm", "interactive mind-map vocabulary");
assertIncludes(js, "showSpeakingTermPopup", "floating vocabulary detail card");
assertIncludes(js, "speakingTermPhonetics", "local IPA vocabulary data");
assertIncludes(js, "findOnlinePhonetic", "fallback IPA lookup");
assertIncludes(js, "data-speaking-term", "clickable vocabulary term");
