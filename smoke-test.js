...
const speakingTips = fs.readFileSync(path.join(root, "speaking-tips-data.js"), "utf8");
...
assertIncludes(html, 'id="speakingTipsList"', "speaking answer skills list");
...
assertIncludes(html, 'src="speaking-tips-data.js?', "versioned speaking skills data script");
...
assertIncludes(speakingTips, "simonSpeakingTips", "Simon speaking skills data");
assertIncludes(speakingTips, "录音—转写—分析—重答", "record-transcribe-analyse technique");
assertIncludes(speakingTips, "Part 1 要短、完整、直接", "Part 1 answer technique");
assertIncludes(speakingTips, "每个 Cue Card 要点都要展开", "Part 2 answer technique");
assertIncludes(speakingTips, "把 Part 3 当成口头段落", "Part 3 answer technique");
